...
export default function Footer() {
  const cols: [string, [string,string][]][] = [
    ["Browse",  [["Movies","/movies"],["TV Series","/series"],["Dubbed","/dubbed"],["Bollywood","/?r=IN"],["Turkish","/?r=TR"]]],
    ["Genres",  [["Action","#"],["Drama","#"],["Comedy","#"],["Sci-Fi","#"],["Thriller","#"]]],
    ["Support", [["Help","#"],["Privacy","#"],["Terms","#"],["DMCA","#"],["Contact","#"]]],
  ];
  return (
    <footer style={{ background: "#13161c", borderTop: "1px solid rgba(255,255,255,0.07)", marginTop: 32 }}>
      <div style={{ height: 3, background: "linear-gradient(90deg,#f43a09,#ffb766,#68d388,#c2edda,#f43a09)" }} />
      <div style={{ padding: "44px 52px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 32, marginBottom: 36 }}>
          <div>
            ...
            <p style={{ color: "#334155", fontSize: 13, lineHeight: 1.7, maxWidth: 230, marginBottom: 18 }}>Free streaming — Hollywood, Bollywood, Turkish &amp; French in 4K.</p>
          ...
          {cols.map(([h, links]) => (
            <div key={h}>
              <p style={{ margin: "0 0 14px", color: "#f1f5f9", fontSize: 11, fontWeight: 800, textTransform: "uppercase" as const, letterSpacing: "1.5px" }}>{h}</p>
              {links.map(([l, href]) => (
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: 10 }}>
