        ...
        <div style={{ display:"flex", gap:6 }}>
          {["‹","›"].map((ch,i)=>(
            <button key={ch} onClick={()=>scroll(i?1:-1)}
              style={{ background:"#181c24", border:"1px solid rgba(255,255,255,0.07)", color:"#64748b", width:30, height:30, borderRadius:"50%", cursor:"pointer", fontSize:16, display:"flex", alignItems:"center", justifyContent:"center" }}
