...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "POST") {
    ...
    await db`INSERT INTO watchlist(user_id,tmdb_id,media_type,title,poster) VALUES(${uid},${tmdbId},${mediaType},${title??null},${poster??null}) ON CONFLICT(user_id,tmdb_id,media_type) DO NOTHING`;
